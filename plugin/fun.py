...
class Images:
    ...
    async def dict(self, ctx, *keywords):
        ...
        if keywords:
            ...
            embed.add_field(name='example:', value='```{}```'.format(result['list'][0]['example']), inline=False)
            ...
            try:
                ...
                embed.add_field(name='Definition:', value='```{}```'.format(result['list'][1]['definition']), inline=False)
                embed.add_field(name='example:', value='```{}```'.format(result['list'][1]['example']), inline=False)
                ...
                try:
                    embed.add_field(name='Word:', value='```{}```'.format(result['list'][2]['word']), inline=False)
                    embed.add_field(name='Definition:', value='```{}```'.format(result['list'][2]['definition']), inline=False)
                    embed.add_field(name='example:', value='```{}```'.format(result['list'][2]['example']), inline=False)
