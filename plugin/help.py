...
class Help:
    ...
    async def rtfm(self, ctx, obj=None):
        ...
        for i in obj:
            if i == 'html' or 'http' in i or 'library' in i or 'stable' in i or 'readthedocs' in i or 'http://aiohttp.readthedocs.org/' in i:
                obj.remove(i)

        for i in obj_links:
            if 'https' in i or len(i) <= 1 or 'stable' in i or 'readthedocs' in i or 'http://aiohttp.readthedocs.org/' in i:
                obj_links.remove(i)
