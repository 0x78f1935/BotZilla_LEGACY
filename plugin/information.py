...
class Information:
    ...
    async def help(self, ctx):
        ...
        embed.add_field(name="{}Joke".format(self.config['prefix']), value="Ever heard a Chuck Norris joke?", inline=False)
        embed.add_field(name="{}rule34".format(self.config['prefix']), value="Shows graphical content NSFW", inline=True)
        embed.add_field(name="{}count".format(self.config['prefix']), value="Count servers, members, etc etc", inline=False)
