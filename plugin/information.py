...
class Information:
    ...
    async def help(self, ctx):
        ...
        embed.add_field(name="{}8ball".format(self.config['prefix']), value="8ball! Ask BotZilla Any question.", inline=False)
        embed.add_field(name="{}Joke".format(self.config['prefix']), value="Ever heard a Chuck Norris joke?", inline=True)
        embed.add_field(name="{}rule34".format(self.config['prefix']), value="Shows graphical content NSFW", inline=False)
